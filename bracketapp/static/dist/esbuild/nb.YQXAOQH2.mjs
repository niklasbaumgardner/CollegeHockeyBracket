import{d as t,h as C,j as ye,k as x}from"./chunk-XGX4NMMB.mjs";import{a as _e,b as $e,c as Ee,d as h}from"./chunk-YTZDMNTQ.mjs";import{a as p,c as Ce,d as xe,e as Re,f as R,i as Se}from"./chunk-QPYYSUDA.mjs";function Ne(i,e){return()=>i.querySelector(e)}function Ge(i,e){return()=>i.querySelectorAll(e)}var n=class extends ye{constructor(){super();let{queries:e}=this.constructor;if(e)for(let[a,r]of Object.entries(e))r.all?Object.defineProperty(this,a,{get:Ge(this,r.all)}):Object.defineProperty(this,a,{get:Ne(this,r)})}createRenderRoot(){return this}};var S=class extends n{render(){return t`<wa-card
    ...
    >`}};customElements.define("nb-back-button",G);var I=class extends n{static properties={message:{type:String},category:{type:String}};connectedCallback(){super.connectedCallback(),this.removeSelfTask=new p(()=>this.removeSelf(),5e3,{finalizeBeforeUnload:!0}),this.removeSelfTask.arm()}removeSelf(){this.remove()}render(){return t`<wa-callout variant=${this.category}>
      ...
      >
    </wa-dropdown>`}};customElements.define("nb-theme-selector",U);var y=new Date("2025-03-27T18:00:00.000Z"),j=class extends n{static properties={bracketsOpen:Boolean};get countdown(){let e=y-Date.now(),a=e/1e3,r=new Date(e),s=Math.floor(a/(3600*24)),o=r.toISOString().substring(11,13),c=r.toISOString().substring(14,16),m=r.toISOString().substring(17,19);return{days:s,hours:o,mins:c,secs:m}}connectedCallback(){super.connectedCallback(),!this.maybeDestroy()&&(this.intervalID=setInterval(()=>{this.maybeRequestUpdate()},1e3))}maybeRequestUpdate(){this.maybeDestroy()||this.requestUpdate()}destroy(){clearInterval(this.intervalID),this.remove()}maybeDestroy(){let e=y-Date.now();return!CAN_EDIT_BRACKET||e<0?(this.destroy(),!0):!1}timeCardTemplate(e,a){return t`<wa-card class="default-bg default-border"
    ...
    >`}};customElements.define("nb-countdown",j);var Ie=[["Mich.","Michigan"],["St.","State"],["U.","University"],["UConn","Connecticut"]];function g(i){for(let[e,a]of Ie)if(i.endsWith(e))return i.replace(e,a);return i}var O=class{constructor(){this.cache=new Map,this.gamesRequestPromise=null,this.gamesJsonPromise=null,this.standingsRequestPromise=null,this.standingsJsonPromise=null,this.confStandingsRequestPromise=null,this.confStandingsJsonPromise=null}async getGames(){this.cache.has(`${CURRENT_YEAR}.games`)&&this.cache.get(`${CURRENT_YEAR}.games`),this.gamesRequestPromise||(this.gamesRequestPromise=fetch(`/static/json/${CURRENT_YEAR}.games.json`));let e=await this.gamesRequestPromise;this.gamesJsonPromise||(this.gamesJsonPromise=e.json());let a=await this.gamesJsonPromise;return this.cache.set(`${CURRENT_YEAR}.games`,a),a}async getStandings(){this.cache.has(`${CURRENT_YEAR}.standings`)&&this.cache.get(`${CURRENT_YEAR}.standings`),this.standingsRequestPromise||(this.standingsRequestPromise=fetch(`/static/json/${CURRENT_YEAR}.standings.json`)),this.confStandingsRequestPromise||(this.confStandingsRequestPromise=fetch(`/static/json/${CURRENT_YEAR}.conference.json`));let[e,a]=await Promise.all([this.standingsRequestPromise,this.confStandingsRequestPromise]);this.standingsJsonPromise||(this.standingsJsonPromise=e.json()),this.confStandingsJsonPromise||(this.confStandingsJsonPromise=a.json());let r=await Promise.all([this.standingsJsonPromise,this.confStandingsJsonPromise]);return this.cache.set(`${CURRENT_YEAR}.standings`,r),r}getRecordFromGames(e,a){let r=[0,0,0];for(let s of a)s.tie?r[2]+=1:s.winner===e?r[0]+=1:r[1]+=1;return r}async getHeadToHeadGames(e,a){let r=g(e.name),s=g(a.name),o=await this.getGames(),c=[];for(let m of o)(m.home===r&&m.away===s||m.home===s&&m.away===r)&&c.push(m);return[this.getRecordFromGames(r,c),this.getRecordFromGames(s,c)]}async getHomeAwayNeutralRecord(e){let a=g(e.name),r=await this.getGames(),s=[],o=[],c=[];for(let m of r)m.home===a?m.neutralSite?c.push(m):s.push(m):m.away===a&&(m.neutralSite?c.push(m):o.push(m));return[this.getRecordFromGames(a,s),this.getRecordFromGames(a,o),this.getRecordFromGames(a,c)]}async getStandingsForTeam(e){let a=g(e.name),[r,s]=await this.getStandings(),o=r[a],c=s[a];return!o||!c?(console.log("NO STATS FOR",e,a),null):{...o,...c}}async getNotableWins(e){let a=await this.getGames(),r=g(e.name),s=[];for(let o of a)(o.home===r||o.away===r)&&o.winner===r&&o.notable&&s.push(o);return s}},b=new O;var A=class extends n{static properties={topTeam:{type:Object},topTeamStats:{type:Object},bottomTeam:{type:Object},bottomTeamStats:{type:Object},game:{type:String}};requestUpdate(e,a){return e==="topTeam"&&(this.topTeamStats=null,this.requestTopTeamStats()),e==="bottomTeam"&&(this.bottomTeamStats=null,this.requestBottomTeamStats()),(e==="topTeamStats"||e==="bottomTeamStats")&&this.topTeamStats&&this.bottomTeamStats&&this.requestHeadToHeadStats(),super.requestUpdate(e,a)}async requestHeadToHeadStats(){if(!(this.topTeam?.team&&this.bottomTeam?.team&&this.topTeamStats&&this.bottomTeamStats))return;let[e,a]=await b.getHeadToHeadGames(this.topTeam.team,this.bottomTeam.team);this.topTeamStats.h2h=e,this.bottomTeamStats.h2h=a,this.requestUpdate()}statsTemplate(e,a=!1){let r=a?"self-end text-right":"";return t`<small class="${r}">NPI: ${e.rank}</small>
      <small class="${r}"
      ...
      ${e.h2h?t`<div
          ...
          </div>`:null}`}async requestTopTeamStats(){if(!this.topTeam.team){this.topTeamStats=null;return}let e=await b.getStandingsForTeam(this.topTeam.team),a=await b.getHomeAwayNeutralRecord(this.topTeam.team);this.topTeamStats={...e,records:a}}async requestBottomTeamStats(){if(!this.bottomTeam.team){this.bottomTeamStats=null;return}let e=await b.getStandingsForTeam(this.bottomTeam.team),a=await b.getHomeAwayNeutralRecord(this.bottomTeam.team);this.bottomTeamStats={...e,records:a}}topTeamStatsTemplate(){return this.topTeamStats?t`<div class="grow flex flex-col w-1/2 min-w-[7rem]">
    ...
    >
      ${e}
    </div>`}};customElements.define("nb-bracket-column",$);var W=class extends ${groupsTemplate(){return this.bracket.group_brackets.length?t`<nb-group-bracket-details
      size="small"
    ...
    >
    ...
    </wa-dialog>`}};var F=class extends l{static properties={bracket:{type:Object}};lableTemplate(){return t`Delete bracket named "${this.bracket.name}"?`}contentTemplate(){return t`<form
      ...
      >`}};customElements.define("nb-delete-bracket",F);var H=class extends d{sortBrackets(){for(let e of this.brackets)e.rank=e.group_bracket?.group_rank;super.sortBrackets()}};customElements.define("nb-group-standings-grid",H);var z=class extends n{static properties={bracket:{type:Object}};render(){return t`<div class="wa-cluster">
      <img
        class="standings-img"
    ...
    </div>`}};customElements.define("nb-bracket-card-content",z);var V=class extends n{static properties={bracket:{type:Object}};render(){return t`<wa-card style="--spacing:var(--wa-space-s);"
...
//# sourceMappingURL=nb.YQXAOQH2.mjs.map
