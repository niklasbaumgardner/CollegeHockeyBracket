import{d as t,h as $,j as we,k as E}from"./chunk-XGX4NMMB.mjs";import{a as fe,b as ke,c as ve,d as u}from"./chunk-NB5LNMQ2.mjs";import{a as d,b as Te,d as _e,e as ye,f as $e}from"./chunk-XVEEE6GM.mjs";function Ce(s,e){return()=>s.querySelector(e)}function xe(s,e){return()=>s.querySelectorAll(e)}var i=class extends we{constructor(){super();let{queries:e}=this.constructor;if(e)for(let[a,r]of Object.entries(e))r.all?Object.defineProperty(this,a,{get:xe(this,r.all)}):Object.defineProperty(this,a,{get:Ce(this,r)})}createRenderRoot(){return this}};var C=class extends i{render(){return t`<wa-card
    ...
    >
      ${e}
    </div>`}};customElements.define("nb-bracket-column",_);var L=class extends _{groupsTemplate(){return this.bracket.group_brackets.length?t`<nb-group-bracket-details
      size="small"
    ...
    >
    ...
    </wa-dialog>`}};var D=class extends l{static properties={bracket:{type:Object}};lableTemplate(){return t`Delete bracket named "${this.bracket.name}"?`}contentTemplate(){return t`<form
      ...
      >`}};customElements.define("nb-delete-bracket",D);var q=class extends m{sortBrackets(){for(let e of this.brackets)e.rank=e.group_bracket?.group_rank;super.sortBrackets()}};customElements.define("nb-group-standings-grid",q);var M=class extends i{static properties={bracket:{type:Object}};render(){return t`<div class="wa-cluster">
      <img
        class="standings-img"
    ...
    </div>`}};customElements.define("nb-bracket-card-content",M);var W=class extends i{static properties={bracket:{type:Object}};render(){return t`<wa-card style="--spacing:var(--wa-space-s);"
      ><nb-bracket-card-content
        .bracket=${this.bracket}
      ></nb-bracket-card-content
    ></wa-card>`}};customElements.define("nb-bracket-card",W);var Y=class extends i{static properties={group:{type:Object}};render(){return t`<div class="wa-cluster">
      <wa-icon
    ...
    </div>`}};customElements.define("nb-group-card-content",Y);var F=class extends i{static properties={group:{type:Object}};render(){return t`<wa-card style="--spacing:var(--wa-space-s);"
    ...
    >
      ...
      form="new-group-form"
      >Create</wa-button
    >`}};customElements.define("nb-create-group",se);var ne=class extends i{static properties={email:{type:String}};static queries={};render(){return t`<wa-card>
    ...
    </div>`}};customElements.define("nb-bracket",pe);var ue=class extends l{static properties={group:{type:Object},controller:{type:Object}};handleHide(){this.controller.show()}lableTemplate(){return t`Delete this group?`}contentTemplate(){return t`<form
    ...
    >
      ...
      <wa-button
        ...
        disabled
        >Save</wa-button
      >`}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.private=this.group.is_private}};customElements.define("nb-edit-group",he);var ge=class extends l{static properties={group:{type:Object}};lableTemplate(){return t`Join ${this.group.name}`}contentTemplate(){return t`<form
