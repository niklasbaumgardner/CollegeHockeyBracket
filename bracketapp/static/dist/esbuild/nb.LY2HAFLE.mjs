import{d as t,h as x,j as ye,k as f}from"./chunk-XGX4NMMB.mjs";import{a as _e,b as $e,c as Ee,d as w}from"./chunk-YTZDMNTQ.mjs";import{a as u,c as Ce,d as xe,e as Se,f as S,i as Re}from"./chunk-P43BX2YJ.mjs";function Ne(i,e){return()=>i.querySelector(e)}function Ie(i,e){return()=>i.querySelectorAll(e)}var n=class extends ye{constructor(){super();let{queries:e}=this.constructor;if(e)for(let[a,r]of Object.entries(e))r.all?Object.defineProperty(this,a,{get:Ie(this,r.all)}):Object.defineProperty(this,a,{get:Ne(this,r)})}createRenderRoot(){return this}};var R=class extends n{render(){return t`<wa-card
      ><form method="POST">
        <div class="wa-stack">
          <wa-input
            name="team"
    ...
    >
      ...
      >`}};customElements.define("nb-delete-bracket",W);var Y=class extends p{sortBrackets(){for(let e of this.brackets)e.rank=e.group_bracket?.group_rank;super.sortBrackets()}};customElements.define("nb-group-standings-grid",Y);var H=class extends n{static properties={bracket:{type:Object}};render(){return t`<div class="wa-cluster">
      <img
        class="standings-img"
...
//# sourceMappingURL=nb.LY2HAFLE.mjs.map
