import{d as t,h as $,j as fe,k as E}from"./chunk-XGX4NMMB.mjs";import{a as ke,b as ve,c as Te,d as u}from"./chunk-NB5LNMQ2.mjs";import{a as d,b as _e,d as ye,e as $e,f as Ee}from"./chunk-SADXGP7D.mjs";function xe(s,e){return()=>s.querySelector(e)}function Be(s,e){return()=>s.querySelectorAll(e)}var i=class extends fe{constructor(){super();let{queries:e}=this.constructor;if(e)for(let[a,r]of Object.entries(e))r.all?Object.defineProperty(this,a,{get:Be(this,r.all)}):Object.defineProperty(this,a,{get:xe(this,r)})}createRenderRoot(){return this}};var C=class extends i{render(){return t`<wa-card
      ><form method="POST">
        <div class="wa-stack">
          <wa-input
            name="team"
    ...
    >`}};customElements.define("nb-add-team",C);var x=class extends i{render(){return t`<wa-card>
      <div class="wa-stack">
    ...
    </wa-card>`}};customElements.define("nb-admin",x);var B=class extends i{static properties={archivedYears:{type:Array}};imgTemplate(e){return e?t`<img
      class="w-[75px] h-[75px]"
    ...
    >`}};customElements.define("nb-countdown",I);var O=class extends i{static properties={topTeam:{type:Object},bottomTeam:{type:Object},game:{type:String}};render(){return this.topTeam?.team&&this.bottomTeam?.team?t`<wa-button
        id="${this.game}-info"
        class="info-button"
        appearance="plain"
        size="small"
    ...
    />`}popoverTemplate(){return this.winnerTop?.team&&this.winnerBottom?.team?t`<wa-button
      ...
      <nb-matchup-info
        ...
        game=${this.game}
      ></nb-matchup-info>
    </div>`}};customElements.define("nb-edit-matchup",g);var P=class extends i{static properties={default:{type:Object},teams:{type:Array}};teamOptions(e,a){let r=this.teams.map(n=>t`<option
          value=${n.id}
    ...
    </wa-card>`}};customElements.define("nb-edit-correct-matchup",U);var j=class extends b{matchupTagName="nb-edit-correct-matchup";maybeToggleSaveButton(){}matchupTemplate(e){return t`<nb-edit-correct-matchup
      id=${e.game}
    ...
    </div>`}};customElements.define("nb-edit-correct-bracket",j);var A=class extends i{static properties={email:{type:String}};connectedCallback(){super.connectedCallback();let a=new URLSearchParams(window.location.search).get("next");a&&window.localStorage.setItem("next",a)}nativeTemplate(){return t`<wa-card>
    ...
    >
      ${e}
    </div>`}};customElements.define("nb-bracket-column",_);var D=class extends _{groupsTemplate(){return this.bracket.group_brackets.length?t`<nb-group-bracket-details
      size="small"
    ...
    >`}render(){return t`<wa-dialog
      @input=${this.inputEvent?this.handleInput:$}
      @submit=${this.submitEvent?this.handleSubmit:$}
    >
    ...
    </wa-dialog>`}};var q=class extends l{static properties={bracket:{type:Object}};lableTemplate(){return t`Delete bracket named "${this.bracket.name}"?`}contentTemplate(){return t`<form
      ...
      >`}};customElements.define("nb-delete-bracket",q);var M=class extends m{sortBrackets(){for(let e of this.brackets)e.rank=e.group_bracket?.group_rank;super.sortBrackets()}};customElements.define("nb-group-standings-grid",M);var W=class extends i{static properties={bracket:{type:Object}};render(){return t`<div class="wa-cluster">
      <img
        class="standings-img"
    ...
    </div>`}};customElements.define("nb-bracket-card-content",W);var Y=class extends i{static properties={bracket:{type:Object}};render(){return t`<wa-card style="--spacing:var(--wa-space-s);"
    ...
    ></wa-card>`}};customElements.define("nb-group-card",z);var w=class extends i{static properties={label:{type:String},value:{type:String},name:{type:String},icon:{type:String},form:{type:String}};static queries={input:"input"};iconTemplate(){return this.icon?t`<wa-icon name=${this.icon}></wa-icon>`:null}labelTemplate(){return t`<span>${this.label}</span>`}render(){return t`<wa-card class="nb-radio-item">
    ...
    >`}};customElements.define("nb-group-add-bracket",V);var J=class extends l{static properties={bracket:{type:Object},group:{type:Object}};lableTemplate(){return t`Remove Bracket?`}contentTemplate(){return t`<form
    ...
    ></nb-group-radio-item>`}groupsTemplate(){let e=this.groupsCanJoin.map(a=>this.groupTemplate(a));return e.length===0&&(e=t`<div class="flex justify-center">
      ...
      >Add Bracket</wa-button
    >`}};customElements.define("nb-add-bracket-to-group",ee);var te=class extends i{static properties={groupBrackets:{type:Array},size:{type:String}};groupBracketTemplate(e){return t`<wa-card class="group-bracket-card ${this.size} default-border"
      ><a
    ...
    >
      ...
      form="new-group-form"
      >Create</wa-button
    >`}};customElements.define("nb-create-group",ne);var oe=class extends i{static properties={email:{type:String}};static queries={};render(){return t`<wa-card>
    ...
    </wa-card>`:null}};customElements.define("nb-preferences",me);var Se="Email taken. Please choose a different email or login.",Ge="Username taken. Please choose a different username.",f=class extends i{static properties={email:{type:String},emailValid:{type:Boolean},usernameValid:{type:Boolean}};static queries={emailInput:"#email",usernameInput:"#username",submitButton:"#submitButtn"};async checkEmailUnique(e){let a=await fetch(EMAIL_UNIQUE_URL+"?"+new URLSearchParams({email:e}));return a=await a.json(),a}async checkUsernameUnique(e){let a=await fetch(USERNAME_UNIQUE_URL+"?"+new URLSearchParams({username:e}));return a=await a.json(),a}async handleEmailInput(){this.emailTask||(this.emailTask=new d(async()=>{let e=this.emailInput.value,a=await this.checkEmailUnique(e);console.log("email is unique",a.isUnique),a.isUnique?(this.emailInput.hint="",this.emailValid=!0):(this.emailInput.hint=Se,this.emailValid=!1)},300)),this.emailTask.arm()}async handleUsernameInput(){this.usernameTask||(this.usernameTask=new d(async()=>{let e=this.usernameInput.value,a=await this.checkUsernameUnique(e);console.log("username is unique",a.isUnique),a.isUnique?(this.usernameInput.hint="",this.usernameValid=!0):(this.usernameInput.hint=Ge,this.usernameValid=!1)},300)),this.usernameTask.arm()}render(){return t`<wa-card>
    ...
    </div>`}};customElements.define("nb-bracket",ue);var he=class extends l{static properties={group:{type:Object},controller:{type:Object}};handleHide(){this.controller.show()}lableTemplate(){return t`Delete this group?`}contentTemplate(){return t`<form
    ...
    >
      ...
      <wa-button
        ...
        disabled
        >Save</wa-button
      >`}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.private=this.group.is_private}};customElements.define("nb-edit-group",ge);var be=class extends l{static properties={group:{type:Object}};lableTemplate(){return t`Join ${this.group.name}`}contentTemplate(){return t`<form
    ...
    >
      ...
      .brackets=${this.brackets}
      year=${this.year}
    ></nb-group-standings-grid>`}render(){return this.year?t`${super.render()}`:null}};customElements.define("nb-group-standings",we);
//# sourceMappingURL=nb.Q2K4XGQN.mjs.map
