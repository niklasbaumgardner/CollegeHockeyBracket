import{d as t,h as x,j as Te,k as f}from"./chunk-XGX4NMMB.mjs";import{a as ye,b as _e,c as $e,d as b}from"./chunk-YTZDMNTQ.mjs";import{a as u,c as Ee,d as Ce,e as xe,f as R,i as Re}from"./chunk-QPYYSUDA.mjs";function Se(i,e){return()=>i.querySelector(e)}function Ne(i,e){return()=>i.querySelectorAll(e)}var n=class extends Te{constructor(){super();let{queries:e}=this.constructor;if(e)for(let[a,r]of Object.entries(e))r.all?Object.defineProperty(this,a,{get:Ne(this,r.all)}):Object.defineProperty(this,a,{get:Se(this,r)})}createRenderRoot(){return this}};var B=class extends n{render(){return t`<wa-card
      ><form method="POST">
        <div class="wa-stack">
          <wa-input
            name="team"
    ...
    >`}};customElements.define("nb-add-team",B);var S=class extends n{render(){return t`<wa-card>
      <div class="wa-stack">
    ...
    </wa-card>`}};customElements.define("nb-admin",S);var N=class extends n{static properties={archivedYears:{type:Array}};imgTemplate(e){return e?t`<img
      class="w-[75px] h-[75px]"
    ...
    />`:null}yearsTemplate(){return this.archivedYears.map(e=>t`<wa-card class="w-full"
      ...
      >
    </wa-dropdown>`}};customElements.define("nb-theme-selector",P);var _=new Date("2025-03-27T18:00:00.000Z"),O=class extends n{static properties={bracketsOpen:Boolean};get countdown(){let e=_-Date.now(),a=e/1e3,r=new Date(e),s=Math.floor(a/(3600*24)),o=r.toISOString().substring(11,13),l=r.toISOString().substring(14,16),m=r.toISOString().substring(17,19);return{days:s,hours:o,mins:l,secs:m}}connectedCallback(){super.connectedCallback(),!this.maybeDestroy()&&(this.intervalID=setInterval(()=>{this.maybeRequestUpdate()},1e3))}maybeRequestUpdate(){this.maybeDestroy()||this.requestUpdate()}destroy(){clearInterval(this.intervalID),this.remove()}maybeDestroy(){let e=_-Date.now();return!CAN_EDIT_BRACKET||e<0?(this.destroy(),!0):!1}timeCardTemplate(e,a){return t`<wa-card class="default-bg default-border"
    ...
    />`}popoverTemplate(){return this.winnerTop?.team&&this.winnerBottom?.team?t`<wa-button
      ...
      <nb-matchup-info
        ...
        game=${this.game}
      ></nb-matchup-info>
    </div>`}};customElements.define("nb-edit-matchup",k);var A=class extends n{static properties={default:{type:Object},teams:{type:Array}};teamOptions(e,a){let r=this.teams.map(s=>t`<option
          value=${s.id}
    ...
    </div>`}};customElements.define("nb-edit-bracket",v);var q=class i extends k{static properties={topTeamGoals:{type:Number,converter:i.goalConverter},bottomTeamGoals:{type:Number,converter:i.goalConverter}};static goalConverter(e,a){return e.length?Number(e):null}teamTemplate(e){return e?.team?e.team.name:""}topScoreInput(){return t`<input
      type="number"
    ...
    </wa-card>`}};customElements.define("nb-edit-correct-matchup",q);var D=class extends v{matchupTagName="nb-edit-correct-matchup";maybeToggleSaveButton(){}matchupTemplate(e){return t`<nb-edit-correct-matchup
      id=${e.game}
    ...
    >`}};customElements.define("nb-create-group",me);var ce=class extends n{static properties={email:{type:String}};static queries={};render(){return t`<wa-card>
      ...
      <wa-button
        ...
        >Reset</wa-button
      >
    </div>`}bgNumberRadioTemplate(){if(!this.backgroundColorSelect){this.updateComplete.then(()=>this.requestUpdate());return}let e=this.backgroundColorSelect.value?.toLowerCase();if(R.includes(e))return xe.map(a=>t`<input
    ...
    </div>`}variantsTemplate(){return Ce.map(e=>t`<wa-select
          with-clear
          id="${e}-color"
          name=${e}
          label="${C(e)} Color"
          @input=${this.handleVariantChange}
          >${Ee.map(a=>t`<wa-option
    ...
    </div>`}};customElements.define("nb-bracket-points-chart",ge);var be=class extends n{static properties={bracket:{type:Object},correct:{type:Object},default:{type:Object},type:{type:String}};getImageElement(e,a=!1){if(!e)return null;let r=a||!this.correct.winner_id||this.correct.winner_id===e.id;return t`<img
    ...
    </div>`}};customElements.define("nb-bracket",be);var we=class extends c{static properties={group:{type:Object},controller:{type:Object}};handleHide(){this.controller.show()}lableTemplate(){return t`Delete this group?`}contentTemplate(){return t`<form
...
//# sourceMappingURL=nb.QUHRWO5F.mjs.map
